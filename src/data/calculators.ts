...
const calculators: CalculatorConfig[] = [
	...
	// ==========================================
	{
		...
		category: 'Health',
		metaDescription: 'Check body mass index from your height and weight.',
		inputs: [
		...
		faq: [
			{ question: 'What are the official BMI categories?', answer: 'Underweight (<18.5), Normal (18.5–24.9), Overweight (25–29.9), Obese (≥30).' },
		],
		relatedSlugs: ['calorie-calculator', 'water-intake-calculator'],
		content: makeContent(
			'The BMI Calculator provides a quick screening ratio based on weight and height.',
			'The formula divides weight in kilograms by height in meters squared.',
			'Formula: BMI = Weight (kg) / [Height (m)]².',
			[
				{ title: 'Healthy Adult', description: '70 kg at 175 cm.', values: { weightKg: 70, heightCm: 175 }, result: '22.86 kg/m² (Normal weight)' },
			],
		),
	},
	{
		...
		category: 'Health',
		metaDescription: 'Estimate daily calorie needs from body data and activity level.',
		inputs: [
		...
		faq: [
			{ question: 'What formula is used?', answer: 'This calculator uses the Mifflin-St Jeor equation, considered one of the most reliable BMR formulas.' },
		],
		relatedSlugs: ['bmi-calculator', 'water-intake-calculator'],
		content: makeContent(
			'The Calorie Calculator estimates Total Daily Energy Expenditure (TDEE) based on basal metabolic rate and daily physical movement.',
			'The calculation applies the Mifflin-St Jeor equation multiplied by an activity factor.',
			'Formula: BMR = (10 × kg) + (6.25 × cm) - (5 × age) + sexOffset; TDEE = BMR × Activity.',
			[
				{ title: 'Active Male', description: '72 kg, 178 cm, 30 years old, moderate exercise.', values: { weightKg: 72, heightCm: 178, ageYears: 30, sex: 'male', activityLevel: 'moderate' }, result: '2616 kcal / day' },
			],
		),
	},
	{
		...
		category: 'Health',
		metaDescription: 'Estimate daily hydration targets from weight and activity.',
		inputs: [
		...
		faq: [
			{ question: 'How much water should I drink per day?', answer: 'A common rule of thumb is 35 ml per kg of bodyweight, with extra for workout sweat and heat.' },
		],
		relatedSlugs: ['bmi-calculator', 'calorie-calculator'],
		content: makeContent(
			'The Water Intake Calculator estimates optimal daily fluid consumption tailored to your weight, daily workouts, and ambient weather.',
			'The formula multiplies body mass by baseline hydration factors and adds sweat replenishment.',
			'Formula: Liters = [ (Weight kg × 35) + (Exercise min × 12) ] × Climate / 1000.',
			[
				{ title: 'Daily Target', description: '70 kg with 30 min exercise.', values: { weightKg: 70, exerciseMinutes: 30, climate: 'moderate' }, result: '2.81 liters / day' },
			],
		),
	},
	...
	// ==========================================
	{
		...
		title: 'Word Counter',
		category: 'Text Tools',
		metaDescription: 'Count words and sentences in a pasted paragraph.',
		inputs: [
		...
		faq: [
			{ question: 'How are words counted?', answer: 'Words are identified by whitespace separation and non-space character boundaries.' },
		],
		relatedSlugs: ['character-counter', 'case-converter'],
		content: makeContent(
			'The Word Counter provides an instant word total for essays, blog drafts, articles, or social copy.',
			'The counter matches all non-whitespace token clusters in the text.',
			'Formula: Word Count = Count of whitespace-delimited tokens.',
			[
	...
	},
	{
		...
		category: 'Text Tools',
		metaDescription: 'Count every character in a sentence, including spaces.',
		inputs: [
		...
		faq: [
			{ question: 'Do spaces count?', answer: 'Yes, this tool counts every visible and whitespace character.' },
		],
		relatedSlugs: ['word-counter', 'case-converter'],
		content: makeContent(
			'The Character Counter measures raw character length for form inputs, social media bios, SMS limits, and SEO titles.',
			'The formula counts string length directly in browser memory.',
