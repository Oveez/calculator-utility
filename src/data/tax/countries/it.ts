...
export const itProfile: CountryTaxProfile = {
  ...
  years: {
    '2026': {
      ...
      regions: [
        { code: 'national_avg', name: 'National Average (~1.73%)', additionalTaxRate: 0.0173 },
        { code: 'lombardy', name: 'Lombardia (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'lazio', name: 'Lazio (~3.33%)', additionalTaxRate: 0.0333 },
        { code: 'veneto', name: 'Veneto (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'piedmont', name: 'Piemonte (~2.03%)', additionalTaxRate: 0.0203 },
        { code: 'emilia_romagna', name: 'Emilia-Romagna (~1.33%)', additionalTaxRate: 0.0133 },
        { code: 'toscana', name: 'Toscana (~1.42%)', additionalTaxRate: 0.0142 },
        { code: 'sicilia', name: 'Sicilia (~1.73%)', additionalTaxRate: 0.0173 },
        { code: 'campania', name: 'Campania (~3.33%)', additionalTaxRate: 0.0333 },
        { code: 'puglia', name: 'Puglia (~1.73%)', additionalTaxRate: 0.0173 },
        { code: 'sardegna', name: 'Sardegna (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'liguria', name: 'Liguria (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'friuli', name: 'Friuli Venezia Giulia (~0.70%)', additionalTaxRate: 0.007 },
        { code: 'calabria', name: 'Calabria (~2.03%)', additionalTaxRate: 0.0203 },
        { code: 'trentino', name: 'Trentino-Alto Adige (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'marche', name: 'Marche (~1.73%)', additionalTaxRate: 0.0173 },
        { code: 'abruzzo', name: 'Abruzzo (~1.73%)', additionalTaxRate: 0.0173 },
        { code: 'umbria', name: 'Umbria (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'basilicata', name: 'Basilicata (~1.23%)', additionalTaxRate: 0.0123 },
        { code: 'molise', name: 'Molise (~2.33%)', additionalTaxRate: 0.0233 },
        { code: 'valle_aosta', name: "Valle d'Aosta (~1.23%)", additionalTaxRate: 0.0123 },
      ],
      vatConfig: {
        name: 'IVA',
