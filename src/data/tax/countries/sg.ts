...
export const sgProfile: CountryTaxProfile = {
  ...
  metaDescription: 'Calculate Singapore individual resident income tax, employee CPF contributions, and take-home pay with official IRAS tax rates.',
  faqItems: [
    {
      question: 'What are the individual income tax rates in Singapore?',
    ...
    {
      question: 'What is the employee Central Provident Fund (CPF) rate in Singapore?',
      answer: 'Singapore citizens and permanent residents aged 55 and below contribute 20% of their monthly wage to CPF, subject to the statutory monthly wage ceiling (OW ceiling).',
    },
  ],
  years: {
    '2025': {
      ...
      socialContributions: [
        {
          ...
          rate: 0.20,
          employeeRate: 0.20,
          capAmount: 88800, // Monthly ordinary wage ceiling annualized ($7,400 * 12)
          description: '20% employee CPF contribution for citizens/PRs aged 55 and below.',
        },
      ],
      vatConfig: {
        name: 'GST',
      ...
      officialSourceName: 'Inland Revenue Authority of Singapore (IRAS)',
      officialSourceUrl: 'https://www.iras.gov.sg',
      lastVerifiedDate: '2025-01-15',
      assumptions: [
        'Tax resident individual for the Year of Assessment (YA)',
        'Singapore Citizen / Permanent Resident aged 55 or below for standard CPF rate',
