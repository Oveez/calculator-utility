...
export const chProfile: CountryTaxProfile = {
  ...
  years: {
    '2026': {
      ...
      regions: [
        { code: 'zh', name: 'Zürich (~12%)', additionalTaxRate: 0.12 },
        { code: 'be', name: 'Bern (~14%)', additionalTaxRate: 0.14 },
        { code: 'lu', name: 'Luzern (~12%)', additionalTaxRate: 0.12 },
        { code: 'ur', name: 'Uri (~10%)', additionalTaxRate: 0.10 },
        { code: 'sz', name: 'Schwyz (~9%)', additionalTaxRate: 0.09 },
        { code: 'ow', name: 'Obwalden (~10%)', additionalTaxRate: 0.10 },
        { code: 'nw', name: 'Nidwalden (~8%)', additionalTaxRate: 0.08 },
        { code: 'gl', name: 'Glarus (~12%)', additionalTaxRate: 0.12 },
        { code: 'zg', name: 'Zug (~8%)', additionalTaxRate: 0.08 },
        { code: 'fr', name: 'Fribourg / Freiburg (~14%)', additionalTaxRate: 0.14 },
        { code: 'so', name: 'Solothurn (~14%)', additionalTaxRate: 0.14 },
        { code: 'bs', name: 'Basel-Stadt (~15%)', additionalTaxRate: 0.15 },
        { code: 'bl', name: 'Basel-Landschaft (~13%)', additionalTaxRate: 0.13 },
        { code: 'sh', name: 'Schaffhausen (~12%)', additionalTaxRate: 0.12 },
        { code: 'ar', name: 'Appenzell Ausserrhoden (~12%)', additionalTaxRate: 0.12 },
        { code: 'ai', name: 'Appenzell Innerrhoden (~10%)', additionalTaxRate: 0.10 },
        { code: 'sg', name: 'St. Gallen (~13%)', additionalTaxRate: 0.13 },
        { code: 'gr', name: 'Graubünden (~13%)', additionalTaxRate: 0.13 },
        { code: 'ag', name: 'Aargau (~11%)', additionalTaxRate: 0.11 },
        { code: 'tg', name: 'Thurgau (~12%)', additionalTaxRate: 0.12 },
        { code: 'ti', name: 'Ticino (~14%)', additionalTaxRate: 0.14 },
        { code: 'vd', name: 'Vaud (~16%)', additionalTaxRate: 0.16 },
        { code: 'vs', name: 'Valais / Wallis (~13%)', additionalTaxRate: 0.13 },
        { code: 'ne', name: 'Neuchâtel (~16%)', additionalTaxRate: 0.16 },
        { code: 'ge', name: 'Genève (~17%)', additionalTaxRate: 0.17 },
        { code: 'ju', name: 'Jura (~16%)', additionalTaxRate: 0.16 },
