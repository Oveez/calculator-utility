...
export const chProfile: CountryTaxProfile = {
  ...
  metaDescription: 'Calculate Swiss federal, cantonal, and municipal taxes, AHV/IV/EO, and ALV social security deductions with official Federal Tax Administration (ESTV) data.',
  faqItems: [
    {
      question: 'How is income tax structured in Switzerland?',
    ...
    {
      question: 'What are mandatory 1st pillar social deductions in Switzerland?',
    ...
    '2025': {
      ...
      socialContributions: [
        ...
        },
        {
          ...
          employeeRate: 0.011,
          capAmount: 148200,
          description: '1.10% unemployment contribution up to statutory ceiling.',
        },
      ],
      regions: [
