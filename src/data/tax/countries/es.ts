...
export const esProfile: CountryTaxProfile = {
  ...
  years: {
    '2026': {
      ...
      regions: [
        { code: 'general', name: 'General (State-regulated regional scale)', flatRate: 0 },
        { code: 'madrid', name: 'Comunidad de Madrid', additionalTaxRate: -0.015 },
        { code: 'catalonia', name: 'Cataluña', additionalTaxRate: 0.015 },
        { code: 'andalucia', name: 'Andalucía', flatRate: 0 },
        { code: 'valencia', name: 'Comunitat Valenciana', additionalTaxRate: 0.01 },
        { code: 'galicia', name: 'Galicia', additionalTaxRate: 0.005 },
        { code: 'castilla_leon', name: 'Castilla y León', flatRate: 0 },
        { code: 'pais_vasco', name: 'País Vasco (Régimen Foral)', additionalTaxRate: -0.01 },
        { code: 'canarias', name: 'Canarias (IGIC zone)', additionalTaxRate: -0.005 },
        { code: 'aragon', name: 'Aragón', additionalTaxRate: 0.005 },
        { code: 'castilla_mancha', name: 'Castilla-La Mancha', additionalTaxRate: 0.005 },
        { code: 'murcia', name: 'Región de Murcia', additionalTaxRate: 0.005 },
        { code: 'baleares', name: 'Illes Balears', additionalTaxRate: 0.01 },
        { code: 'extremadura', name: 'Extremadura', additionalTaxRate: 0.01 },
        { code: 'asturias', name: 'Principado de Asturias', additionalTaxRate: 0.01 },
        { code: 'navarra', name: 'Navarra (Régimen Foral)', additionalTaxRate: -0.01 },
        { code: 'cantabria', name: 'Cantabria', additionalTaxRate: 0.005 },
        { code: 'la_rioja', name: 'La Rioja', flatRate: 0 },
        { code: 'ceuta_melilla', name: 'Ceuta y Melilla (50% deduction)', additionalTaxRate: -0.10 },
      ],
      vatConfig: {
        name: 'IVA',
