// ============================================================
// iLovePDF-style icon system — Rich, distinct, detailed icons
//   • Each tool has a UNIQUE multi-element SVG illustration
//   • viewBox="0 0 48 48" for extra detail headroom
//   • badgeBg = SOLID vibrant Tailwind color
//   • iconColor = always 'text-white'
//   • Mix of fill="currentColor" + stroke for layered depth
// ============================================================
...
export interface CategoryIconConfig {
  iconName: string;
  textColor: string;     // Used for text color in tabs/nav (stays colored)
  badgeBg: string;       // Solid bg for icon tile
  badgeBorder: string;   // Transparent for solid tiles
  svgPath: string;
}

// Global category icons — textColor stays colored for nav/tab usage
...
// ============================================================
// Per-tool icon configs — solid bg, white icon, no border
// ============================================================
const specificToolIcons: Record<string, ToolIconConfig> = {

  // 1. PDF Tools — Rose/Red solid
  'pdf-splitter': {
    badgeBg: 'bg-rose-500',
    badgeBorder: 'border-transparent',
  ...
  // 3. Generators & Barcodes — Amber solid
  'qr-code-generator': {
    badgeBg: 'bg-amber-500',
    badgeBorder: 'border-transparent',
    iconColor: 'text-white',
  ...
  // 4. Finance Calculators — Emerald solid
  'mortgage-calculator': {
    badgeBg: 'bg-emerald-500',
    badgeBorder: 'border-transparent',
    iconColor: 'text-white',
  ...
  // 6. Academic & Education — Indigo solid
  'gpa-calculator': {
    badgeBg: 'bg-indigo-500',
    badgeBorder: 'border-transparent',
    iconColor: 'text-white',
  ...
  // 10. Shipping & Logistics — Sky/Blue solid
  'cbm-calculator': {
    badgeBg: 'bg-sky-500',
    badgeBorder: 'border-transparent',
    iconColor: 'text-white',
...
export function getToolIconConfig(slugOrUrl: string, title?: string, category?: string): ToolIconConfig {
  ...
  // 3. Fallback to Category — solid bg, white icon
